...
int main(int argc, char *argv[])
{
    if(argc < 3)
    {
        cout << "Send either 'black' or 'white' as first argument for which colour goes first." << endl;
        cout << "Send either '0' or '1' as second argument for which AI goes first." << endl;
        return 0;
    }
    bool whiteFirst;
